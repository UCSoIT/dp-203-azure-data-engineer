...
1. In the Azure portal, browse to the **dp203-24-*xxxxxxx*** resource group that was created by the script you ran.
...
2. In the **Import Notebooks** dialog box, select **URL** and import the notebook from `https://github.com/venkatvvg/dp-203-azure-data-engineer/raw/master/Allfiles/labs/24/Databricks-Spark.ipynb`.
...
3. Select the **dp203-24-*xxxxxxx*** resource group (not the managed resource group), and verify that it contains your Azure Databricks workspace.
4. At the top of the **Overview** page for your resource group, select **Delete resource group**.
5. Enter the **dp203-24-*xxxxxxx*** resource group name to confirm you want to delete it, and select **Delete**.
